...
export const FooterMeta: React.FC<Props> = ({
  ...
  return (
    <div className="mt-10 border-t border-neutral-800 pt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between text-xs font-mono text-neutral-600">
      <p>
